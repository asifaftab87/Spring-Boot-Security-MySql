     ...
     %>
        ...
        <li class="nav-item dropdown">
	        <a class="nav-link dropdown-toggle text-white" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      		...
      		<div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
    			<a class="dropdown-item text-light bg-dark" href="/user/profile">Profile</a>
    			<a class="dropdown-item text-light bg-dark" href="/user/password">Change Password</a>
    			<a class="dropdown-item text-light bg-dark" href="/user/picture">Change Profile Picture</a>
    			<a class="dropdown-item text-light bg-dark" href="/logout">Logout</a>
			</div>
		</li> 
